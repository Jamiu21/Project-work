...
/* assignment2 of semester 
    This program will play a Lotto game. This program allows the user to enter their 6 selected 
    numbers and they have a set amount of options, each performing a specific requirement. 6 selected
    numbers are stored in a 1-Dimensional array.
    Using functions and pointer notations to access array

    it also Sort the contents of the array in increasing order 
    The program compares the inputted data with the winning nubers and see it theres
    matches. based on the matches using values and loops we the user can see how many numbers are winnings
    numbers.

    lastly the final part of the program allows the user to see the frequency of the numbers they entered each time the user enters a new
...
main()
{
    ...
    do
    {
        ...
        printf("*******************************************************\n");
        printf("\n\t\tInstructions\n");
        printf("1. Press \"a\" key to enter 6 numbers then click enter key.\n");
        printf("2. Press \"b\" key to show your selected numbers.\n");
        printf("3. To sort numbers enter \"c\" key.\n");
        printf("4. Enter \"d\" key to compare numbers with winning numbers.\n");
        printf("5. For a frequency table enter \"e\" key\n");
        printf("6. To end game pick \"f\" \n");
        printf("*******************************************************\n");
        puts("Menu");
        puts("a.)Enter six different numbers to play the Lotto (1-42)");
    ...
    for (i = 0; i < SELECTED; i++)
    {
        ...
        if (*(numbers + i) >= 1 && *(numbers + i) <= 42)
        {
            ...
            for (j = 0; j < i; j++)
            {
                ...
                {
                    puts("You can't enter the same number");
                    puts("The game will start over");
        ...
        else
        {
            ...
            printf("The program will start over \n");
            printf("\n");                    //for neatness
...
void part4(int *compare, int *values)
{
    ...
    {
        puts("You win a Holiday in Japan!");
    } //end else if
